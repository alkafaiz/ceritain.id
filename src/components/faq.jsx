        ...
        <div className="row mt-5">
          <div className="col ">
            ...
            <Accordion
              ...
              content={() => (
                <p>
                  1. Berbagi cerita Social media tempat curhatin masalahmu dalam
                  lingkup yang suportif untuk dukung kesehatan mentalmu!
                  <br></br>2. Mood track Kamu bisa catat sekaligus awasi
                  perubahan suasana hatimu <br></br>3. Mau cerita tanpa
                  di-judge? Bisa! Kami punya konselor kredibel yang bisa
                  dengerin ceritamu via chat. (Ada button untuk langsung
                  konseling)
                </p>
              )}
            />
